            ...
            <li class="list-inline-item dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-right dropdown-profile">
                  <div class="user-profile-area">
                     ...
                     <a href="{{route('client.profile')}}" class="dropdown-item"><i data-feather="user" class="wd-16 mr-2"></i> My profile</a>
                     ...
                     <a href="{{route('adminlogout')}}" class="dropdown-item"><i data-feather="power" class="wd-16 mr-2"></i> Sign-out</a>
                  </div>
               </div>
            </li>
