<div class="page-sidebar">
         ...
         <ul class="accordion-menu">
            ...
            <li class="open active">
               ...
               <ul class="sub-menu" style="display: block;">
                  ...
                  <li><a href="{{route('admin.projects')}}">Project</a></li>
               </ul>
            </li>
            ...
            <li>
               ...
               <ul class="sub-menu">
                  <li><a href="{{route('admin.projects')}}">View Project</a></li>
                  <li><a href="{{route('admin.newproject')}}">Addd New Project</a></li>
   ...
   <div class="sidebar-footer">									
      <a class="pull-left" href="{{route('admin.profile')}}" data-toggle="tooltip" data-placement="top" data-original-title="Profile">
