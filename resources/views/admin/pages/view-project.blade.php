                            ...
                            <div class="row border-bottom pb-5">
                                <div class="col-xl-8 col-lg-9">
                                    <div>
                                        ...
                                        <div class="workload-button">
                                            <a href="{{route('admin.newproject')}}" class="btn btns-primary  btn-rounded">New <i class="fas fa-caret-down ms-2 scale5"></i></a>
                                            <a href="javascript:void(0);" class="btn btns-primary  btn-rounded"><i class="fas fa-user-plus scale2 me-3"></i> Invite Member</a>
                                            <a href="javascript:void(0);" class="btn btn-light btn-rounded">Edit</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mamber d-flex flex-wrap team-avatar align-items-center mt-3">
                                                ...
                                                <h5 class="mr-2">Testers <i class="fa-solid fa-arrow-right"></i> </h5>
                                ...
                                <div class="col-xl-3 mt-4 col-sm-6 ">
                                    <div class="d-flex project-date">
                                        ...
                                        <div>
                                            <p  class="fs-18 font-w500 text-black">Project Budget</p>
                                            <span>{{$projectdetails->project_budget}}</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <hr>
            <form action="{{ route('send-message', $projectdetails->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                          <!-- col-4 -->
          <div class="col-lg-5">
