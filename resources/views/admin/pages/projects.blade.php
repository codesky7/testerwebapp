             ...
             <div class="card mg-b-30">
                 ...
                 <div class="card-body py-3">
                     ...
                     <div class="d-flex flex-wrap team-avatar">
                         ...
                         <a href="#" class="d-block mr-1 mb-1" data-toggle="tooltip" data-placement="top"
                             title="{{ $user->fname }}"><img src="/assets/images/users-face/1.png" alt="{{ $user->name }}"
                                 class="wd-30 rounded-circle"></a>
                         @endforeach
                     </div>
                 </div>
             </div>
